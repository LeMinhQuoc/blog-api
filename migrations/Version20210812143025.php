 ...
 */
final class Version20210812143025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_user_post ON `like` (id_user_id, id_post_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX unique_user_post ON `like`');
